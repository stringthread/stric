...
const std::vector<SyntaxDef> Syntax::syntax_rules {
  ...
  {"def_statement", std::vector<string>({"var_def","ASSIGN","value_expr","EOS"})},
  {"def_statement", std::vector<string>({"var_def","LEFT_BRACKET","RIGHT_BRACKET","ASSIGN","block"})},
  {"def_statement", std::vector<string>({"var_def","LEFT_BRACKET","formal_param_list","RIGHT_BRACKET","ASSIGN","block"})},
  {"def_statement", std::vector<string>({"var_def","LEFT_BRACKET","comma_formal_param_list","RIGHT_BRACKET","ASSIGN","block"})},
  ...
  {"atom_value", std::vector<string>({"DOT","IDENTIFIER","LEFT_BRACKET","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"atom_value","DOT","IDENTIFIER","LEFT_BRACKET","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"DOT","IDENTIFIER","LEFT_BRACKET","comma_list","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"atom_value","DOT","IDENTIFIER","LEFT_BRACKET","comma_list","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"DOT","IDENTIFIER","LEFT_BRACKET","trailing_comma_list","RIGHT_BRACKET"})},
