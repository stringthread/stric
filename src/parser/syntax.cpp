...
const std::vector<SyntaxDef> Syntax::syntax_rules {
  ...
  {"sentence", std::vector<string>({"def_statement"})},
  ...
  {"def_statement", std::vector<string>({"var_def","EOS"})},
  {"def_statement", std::vector<string>({"var_def","EQUAL","value_expr","EOS"})},
  {"def_statement", std::vector<string>({"var_def","LEFT_BRACKET","RIGHT_BRACKET","EQUAL","block"})},
  {"def_statement", std::vector<string>({"var_def","LEFT_BRACKET","formal_param_list","RIGHT_BRACKET","EQUAL","block"})},
  {"def_statement", std::vector<string>({"var_def","LEFT_BRACKET","comma_formal_param_list","RIGHT_BRACKET","EQUAL","block"})},
  //{"type", std::vector<string>({"LEFT_ANGLE_BRACKET","IDENTIFIER","RIGHT_ANGLE_BRACKET"})},
  {"var_def", std::vector<string>({"IDENTIFIER","IDENTIFIER"})},
  {"formal_param_list", std::vector<string>({"var_def"})},
  {"formal_param_list", std::vector<string>({"comma_formal_param_list","var_def"})},
  {"comma_formal_param_list", std::vector<string>({"formal_param_list","COMMA"})},
  // add for ... to sentence
  {"atom_value", std::vector<string>({"IDENTIFIER"})},
  {"atom_value", std::vector<string>({"atom_value","DOT","IDENTIFIER"})},
  {"atom_value", std::vector<string>({"IDENTIFIER","LEFT_BRACKET","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"atom_value","DOT","IDENTIFIER","LEFT_BRACKET","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"IDENTIFIER","LEFT_BRACKET","comma_list","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"atom_value","DOT","IDENTIFIER","LEFT_BRACKET","comma_list","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"IDENTIFIER","LEFT_BRACKET","trailing_comma_list","RIGHT_BRACKET"})},
  {"atom_value", std::vector<string>({"atom_value","DOT","IDENTIFIER","LEFT_BRACKET","trailing_comma_list","RIGHT_BRACKET"})},
  {"comma_list", std::vector<string>({"value_expr"})},
  {"comma_list", std::vector<string>({"trailing_comma_list","value_expr"})},
  {"trailing_comma_list", std::vector<string>({"comma_list","COMMA"})},
  ...
  {"compare_operator", std::vector<string>({"EQEQ"})},
  ...
  {"assign_operator", std::vector<string>({"EQUAL"})},
  /*{"binary_operator_3", std::vector<string>({"math_operator_1","EQUAL"})},
  {"binary_operator_3", std::vector<string>({"math_operator_2","EQUAL"})},*/
