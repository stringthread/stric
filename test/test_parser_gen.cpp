...
TEST_F(DFATest, LR_DFATest){
  ...
  ClosureSet cs7(db, std::vector<ClosureItem>({ci7_1, ci0_2, ci7_3}));
  ...
  ASSERT_TRUE(result[0]->cs.is_same_lr1(cs0))<<result[0]->cs.get_lr1_hash();
  ...
  if(result[0]->edge.count("main")!=0){
    ...
    EXPECT_TRUE(result_1->cs.is_same_lr1(cs1))<<result_1->cs.get_lr1_hash();
  }
  ...
  if(result[0]->edge.count("ATOM")!=0){
    ...
    EXPECT_TRUE(result_2->cs.is_same_lr1(cs2))<<result_2->cs.get_lr1_hash();
  }
  ...
  if(result[0]->edge.count("DIGITS")!=0){
    ...
    EXPECT_TRUE(result_3->cs.is_same_lr1(cs3))<<result_3->cs.get_lr1_hash();
  }
  ...
  if(result[0]->edge.count("LPAREN")!=0){
    ...
    EXPECT_TRUE(result_4->cs.is_same_lr1(cs4))<<result_4->cs.get_lr1_hash();
  }
  ...
  if(result_4->edge.count("ATOM")!=0){
    ...
    EXPECT_TRUE(result_5->cs.is_same_lr1(cs5))<<result_5->cs.get_lr1_hash();
  }
  ...
  if(result_4->edge.count("DIGITS")!=0){
    ...
    EXPECT_TRUE(result_6->cs.is_same_lr1(cs6))<<result_6->cs.get_lr1_hash();
  }
  ...
  if(result_4->edge.count("LPAREN")!=0){
    ...
    EXPECT_TRUE(result_7->cs.is_same_lr1(cs7))<<result_7->cs.get_lr1_hash();
  }
  ...
  if(result_5->edge.count("RPAREN")!=0){
    ...
    EXPECT_TRUE(result_8->cs.is_same_lr1(cs8))<<result_8->cs.get_lr1_hash();
  }
  ...
  if(result_7->edge.count("DIGITS")!=0){
    ...
    EXPECT_TRUE(result_6_2->cs.is_same_lr1(cs6))<<result_6_2->cs.get_lr1_hash();
  }
  ...
  if(result_7->edge.count("LPAREN")!=0){
    ...
    EXPECT_TRUE(result_7_2->cs.is_same_lr1(cs7))<<result_7_2->cs.get_lr1_hash();
  }
  ...
  if(result_7->edge.count("ATOM")!=0){
    ...
    EXPECT_TRUE(result_9->cs.is_same_lr1(cs9))<<result_9->cs.get_lr1_hash();
  }
  ...
  if(result_9->edge.count("RPAREN")!=0){
    ...
    EXPECT_TRUE(result_10->cs.is_same_lr1(cs9))<<result_10->cs.get_lr1_hash();
  }
}
...
TEST_F(DFATest, LALR_DFATest){
  ...
  if(result[0]->edge.count("LPAREN")!=0){
    ...
    EXPECT_TRUE(result_11->cs.is_same_lr1(cs11))<<result_11->cs.get_lr1_hash();
  }
  EXPECT_NE(result[0]->edge.count("DIGITS"),0);
  std::shared_ptr<DFA_Node> result_12;
  if(result[0]->edge.count("DIGITS")!=0){
    result_12=result[0]->edge["DIGITS"].lock();
    EXPECT_TRUE(result_12->cs.is_same_lr1(cs12))<<result_12->cs.get_lr1_hash();
  }
  ...
  if(result_11->edge.count("LPAREN")!=0){
    ...
    EXPECT_TRUE(result_11_2->cs.is_same_lr1(cs11))<<result_11_2->cs.get_lr1_hash();
  }
  ...
  if(result_11->edge.count("DIGITS")!=0){
    ...
    EXPECT_TRUE(result_12_2->cs.is_same_lr1(cs12))<<result_12_2->cs.get_lr1_hash();
  }
  ...
  if(result_11->edge.count("ATOM")!=0){
    ...
    EXPECT_TRUE(result_13->cs.is_same_lr1(cs13))<<result_13->cs.get_lr1_hash();
  }
  ...
  if(result_13->edge.count("RPAREN")!=0){
    ...
    EXPECT_TRUE(result_14->cs.is_same_lr1(cs14))<<result_14->cs.get_lr1_hash();
  }
}
